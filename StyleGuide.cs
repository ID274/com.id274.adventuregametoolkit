...
// - Use camel case (e.g. examplePlayerController, maxHealth, etc.) for variables, parameters.
...
// - Maximum line width is about 200 characters to allow for all the code to be seen without scrolling horizontally, while also leaving enough space for longer code to stay on 1 line for clarity.
...
// - Remove unused lines.
// - Remember to remove unused lines automatically added by Intellisense if spotted.
...
namespace StyleSheetExample
{
    ...
    public class StyleExample : MonoBehaviour
    {
        ...
        // - Use nouns for names. Booleans should use verbs to make it clear what action they are referring to.
        // - Use meaningful names. Make names searchable and pronounceable. Don’t abbreviate (unless it’s math).
        // - Use camel case for both public fields and private variables.
        ...
        // A header can be used to separate certain variables from eachother for clarity if they are meant for different things
        [Header("Bicycle Attributes")]
